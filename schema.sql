...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`id`),
  KEY `course_professor_fk` (`professor_id`),
...
INSERT INTO `course` VALUES (1,'English',1,0,203),(2,'Hindi',1,0,201),(3,'Maths',1,0,202),(4,'Science',0,0,NULL),(5,'History',0,0,NULL),(6,'Jedi',0,NULL,NULL);
...
INSERT INTO `professor` VALUES (201,NULL),(202,1),(203,NULL);
...
CREATE TABLE `registeredCourses` (
  ...
  KEY `registered_student_fk` (`student_id`),
...
INSERT INTO `registeredCourses` VALUES (1,101,NULL),(2,101,'A+'),(3,101,'A+'),(4,101,NULL);
...
INSERT INTO `role` VALUES (1,'Student'),(2,'Professor'),(3,'Admin');
...
INSERT INTO `student` VALUES (101,1),(102,1),(103,1);
...
INSERT INTO `user` VALUES (101,'pass','parth',1),(102,'23','Manan',1),(103,'pass','newstudent',1),(201,'pass','rohit',2),(202,'1234','Ashok',2),(203,'1234','Ashwini',NULL),(301,'pass','shruti',3);
...
-- Dump completed on 2022-06-24 15:06:06
